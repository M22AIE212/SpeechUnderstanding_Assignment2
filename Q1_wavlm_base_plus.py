...
"""## THE TOTAL DATA SIZE WAS AROUND 40 GB. I WAS UNABLE TO EXECUTE SO I TESTED THE MODELS ON SAMPLE DATASET FOR RANDOM 1000 SAMPLES"""
...
df_subset.to_csv("wavlm_base_plus.csv",index = False)
